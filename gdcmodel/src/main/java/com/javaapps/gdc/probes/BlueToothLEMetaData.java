...
public class BlueToothLEMetaData {
	...
	public static class Builder{
    	...
    	private BlueToothLEService.Builder addService(String serviceName,String serviceUUIDStr){
    		BlueToothLEService.Builder serviceBuilder=null;
    		if ( !serviceMetaDataBuilderMap.containsKey(serviceName)){
    			serviceBuilder=
    					new BlueToothLEService.Builder(serviceName,UUID.fromString(serviceUUIDStr));
    	...
    	public void addCharacteristic(String serviceName,String serviceUUIDStr,String characteristicName,
    			String characteristicUUIDStr, String enableCharacteristicUUIDStr,
    			int enableCharacteristicValue, int disableCharacteristicValue){
    		BlueToothLEService.Builder serviceBuilder=addService(serviceName,serviceUUIDStr);
    		serviceBuilder.addCharacteristic(characteristicName, characteristicUUIDStr, enableCharacteristicUUIDStr, 
    	...
    	public BlueToothLEMetaData build(){
    		...
    		for (BlueToothLEService.Builder serviceMetaDataBuilder: serviceMetaDataBuilderMap.values()){
    			BlueToothLEService lowEnergyBlueToothServiceMetaData=serviceMetaDataBuilder.build();
    			serviceMetaDataMap.put(lowEnergyBlueToothServiceMetaData.getServiceName(), lowEnergyBlueToothServiceMetaData);
    		}
